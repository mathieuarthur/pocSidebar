    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 15, 3, 283);
    			attr_dev(div1, "class", "svelte-1d64whd");
    			add_location(div1, file, 16, 3, 298);
    			attr_dev(div2, "class", "svelte-1d64whd");
    			add_location(div2, file, 17, 3, 313);
    			attr_dev(div3, "class", "burger svelte-1d64whd");
    			add_location(div3, file, 14, 2, 189);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(li0, file, 23, 4, 500);
    			add_location(li1, file, 24, 4, 517);
    			add_location(li2, file, 25, 4, 537);
    			add_location(li3, file, 26, 4, 557);
    			attr_dev(ul, "class", "unselectable svelte-1d64whd");
    			add_location(ul, file, 22, 3, 470);
    			attr_dev(div0, "class", div0_class_value = "" + (null_to_empty(`sidebar ${/*visible*/ ctx[0] ? "hidden" : ""}`) + " svelte-1d64whd"));
    			add_location(div0, file, 21, 2, 347);
    			attr_dev(div1, "class", "container svelte-1d64whd");
    			add_location(div1, file, 12, 1, 147);
    			add_location(main, file, 11, 0, 139);
    		},
